...
public class DrawCanvasModule extends ReactContextBaseJavaModule {
    DrawCanvasModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }

    @Override
    public String getName() {
        return "DrawCanvasModule";
    }
        ...
        try {
            ...
            uiManager.addUIBlock(new UIBlock() {
                public void execute(NativeViewHierarchyManager nvhm) {
                    DrawCanvas view = (DrawCanvas) nvhm.resolveView(tag);
