...
public class DrawCanvasManager extends SimpleViewManager<DrawCanvas> {
    ...
    public static DrawCanvas Canvas = null;
    ...
    @Override
    protected DrawCanvas createViewInstance(ThemedReactContext context) {
        DrawCanvasManager.Canvas = new DrawCanvas(context);
        return DrawCanvasManager.Canvas;
    }

    @ReactProp(name = PROPS_LOCAL_SOURCE_IMAGE)
    public void setLocalSourceImage(DrawCanvas viewContainer, ReadableMap localSourceImage) {
    ...
    public void setText(DrawCanvas viewContainer, ReadableArray text) {
    ...
    @Override
    protected void addEventEmitters(ThemedReactContext reactContext, DrawCanvas view) {

    }

    @Override
    public void receiveCommand(DrawCanvas view, int commandType, @Nullable ReadableArray args) {
        switch (commandType) {
