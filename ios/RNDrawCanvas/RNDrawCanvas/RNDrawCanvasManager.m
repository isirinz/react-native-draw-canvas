#import "RNDrawCanvasManager.h"
#import "RNDrawCanvas.h"
#import <React/RCTEventDispatcher.h>
#import <React/RCTView.h>
#import <React/UIView+React.h>
#import <React/RCTUIManager.h>

@implementation RNDrawCanvasManager
...
#pragma mark - Props
RCT_CUSTOM_VIEW_PROPERTY(localSourceImage, NSDictionary, RNDrawCanvas)
{
    RNDrawCanvas *currentView = !view ? defaultView : view;
...
RCT_CUSTOM_VIEW_PROPERTY(text, NSArray, RNDrawCanvas)
{
    RNDrawCanvas *currentView = !view ? defaultView : view;
...
- (UIView *)view
{
    return [[RNDrawCanvas alloc] initWithEventDispatcher: self.bridge.eventDispatcher];
}
...
{
    [self runCanvas:reactTag block:^(RNDrawCanvas *canvas) {
...
- (void)runCanvas:(nonnull NSNumber *)reactTag block:(void (^)(RNDrawCanvas *canvas))block {
    [self.bridge.uiManager addUIBlock:
     ^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNDrawCanvas *> *viewRegistry){

         RNDrawCanvas *view = viewRegistry[reactTag];
         if (!view || ![view isKindOfClass:[RNDrawCanvas class]]) {
             RCTLogError(@"Cannot find RNDrawCanvas with tag #%@", reactTag);
             return;
         }
